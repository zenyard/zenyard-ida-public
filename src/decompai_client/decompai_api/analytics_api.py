...
class AnalyticsApi:
    ...
    @validate_call
    async def track_event_with_http_info(
        self,
        track_event_request: TrackEventRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def track_event_without_preload_content(
        self,
        track_event_request: TrackEventRequest,
        _request_timeout: Union[
            None,
    ...
    def _track_event_serialize(
        ...
        if track_event_request is not None:
            _body_params = track_event_request
