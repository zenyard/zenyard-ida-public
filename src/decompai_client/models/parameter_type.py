...
class ParameterType(BaseModel):
    ...
    ParameterType
    """ # noqa: E501
    type: Optional[StrictStr] = 'parameter_type'
    address: Annotated[str, Field(strict=True)]
    parameter_index: StrictInt
    type_annotation: StrictStr
    struct_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "address", "parameter_index", "type_annotation", "struct_id"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['parameter_type']):
            raise ValueError("must be one of enum values ('parameter_type')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ParameterType from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'parameter_type',
            "address": obj.get("address"),
            "parameter_index": obj.get("parameter_index"),
