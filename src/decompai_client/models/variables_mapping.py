...
class VariablesMapping(BaseModel):
    """
    VariablesMapping
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VariablesMapping from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VariablesMapping from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'variables',
            "address": obj.get("address"),
            "variables_mapping": obj.get("variables_mapping")
        })
        return _obj
